...
export default function AllOrdersForAdmin() {
  ...
  async function allPr(){
    ...
    try {
        ...
        const endpoint = `/orders/allForAdmin`;
...
<TableCell align="center">
           ...
           {row.isCenceled===true && (<TableRow align="center" > &nbsp;&nbsp;&nbsp;&nbsp;Canceled</TableRow>)} 
           {row.isCenceled===false && (<TableRow align="center" > &nbsp;&nbsp;&nbsp;&nbsp;Regularly</TableRow>)} 
